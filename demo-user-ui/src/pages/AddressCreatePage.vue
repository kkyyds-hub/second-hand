...
<template>
  <div class="page-body page-body-narrow">
    <section class="page-header"><div class="page-header-main"><p class="page-kicker">地址</p><h1 class="page-title">新增收货地址</h1><p class="page-desc">填写收件信息和详细地址，保存后可在下单时选择。</p></div><div class="page-actions"><router-link class="btn-default" to="/account/addresses"><ArrowLeft class="h-4 w-4" /><span>返回列表</span></router-link></div></section>
