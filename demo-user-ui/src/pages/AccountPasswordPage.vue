...
<template>
  <div class="page-body page-body-narrow">
    <section class="page-header">
      <div class="page-header-main"><p class="page-kicker">安全</p><h1 class="page-title">修改登录密码</h1><p class="page-desc">修改成功后请使用新密码登录。请勿使用容易猜测的密码。</p></div>
    ...
    <div class="max-w-3xl">
      <section class="section-panel">
        <div class="section-header section-header-plain"><div><h2 class="section-heading">密码设置</h2></div></div>
