...
<template>
  <div class="page-body page-body-narrow">
    <section class="page-header">
      <div class="page-header-main"><p class="page-kicker">安全</p><h1 class="page-title">邮箱绑定</h1><p class="page-desc">管理用于接收账户通知的邮箱。</p></div>
    ...
    <section class="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
      <div class="section-panel-muted">
        ...
        <div class="section-body pt-0"><div class="detail-grid"><div class="detail-row"><span class="detail-label">账户显示名</span><span class="detail-value">{{ displayName }}</span></div><div class="detail-row"><span class="detail-label">已绑定邮箱</span><span class="detail-value font-numeric">{{ currentEmail || '暂未绑定' }}</span></div></div></div>
      </div>
      <div class="space-y-6">
        <section v-if="!hasBoundEmail" class="section-panel">
          <div class="section-header section-header-plain"><div><h2 class="section-heading">绑定邮箱</h2></div></div>
        ...
        <section v-else class="section-panel">
          <div class="section-header section-header-plain"><div><h2 class="section-heading">解除绑定</h2><p class="section-subtitle">解绑后可重新绑定新的邮箱。</p></div></div>
