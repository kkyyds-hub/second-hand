...
function primaryLabel(status: string) { if (status === 'pending') return '等待买家支付'; if (status === 'paid') return '去发货'; if (status === 'shipped') return '查看物流'; return '查看详情' }
